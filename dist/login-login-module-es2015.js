...
LoginComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: LoginComponent, selectors: [["app-login"]], ngContentSelectors: _c0, decls: 16, vars: 3, consts: [["routerLink", "/pages"], ["id", "test2", 1, "class1", "class2"], ["test", ""], [3, "click"], [4, "ngIf", "ngIfElse"], ["esFalso", ""]], template: function LoginComponent_Template(rf, ctx) { if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function LoginComponent_Template_button_click_9_listener() { return ctx.sw = !ctx.sw; });
